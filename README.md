...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gnuradio-osmosdr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gnuradio-osmosdr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gnuradio-osmosdr
# for installing globally
pixi global install gnuradio-osmosdr
```
...
It is possible to list all of the versions of `gnuradio-osmosdr` available on your platform:
...
```
pixi search gnuradio-osmosdr --channel conda-forge
```
